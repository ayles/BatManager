...
namespace BatManager {
    public class WrapPanelLastChildFill : WrapPanel {
        ...
        public static readonly DependencyProperty LastChildFillProperty =
            DependencyProperty.Register("LastChildFill", typeof(bool), typeof(WrapPanelLastChildFill),
        ...
        protected override Size MeasureOverride(Size constraint) {
            ...
            for (int i = 0; i < children.Count; i++) {
                ...
                if (curLineSize.Width + sz.Width > constraint.Width) //need to switch to another line
                {
                    ...
                    if (curLineSize.Width > constraint.Width
        ...
        private void ArrangeLine(double y, Size lineSize, double boundsWidth, int start, int end) {
            ...
            for (int i = start; i < end; i++) {
                ...
                {
                    w = boundsWidth - x;
                    if (w > child.MaxWidth || children.Count - 1 == i) w = child.DesiredSize.Width;
                }
